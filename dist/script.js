...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var pageSlider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_1__["default"]({
    btns: '.next',
    container: '.page'
  });
        ...
        btn.addEventListener('click', function () {
          ...
          try {
            ...
            if (_this.slideIndex == 3) {
              ...
              _this.hanson.style.display = "none";
    ...
    value: function bindTriggers() {
      ...
      this.prev.addEventListener('click', function () {
        ...
        for (var i = _this.slides.length - 1; i > 0; i--) {
          var _active = _this.slides[i];

          _this.container.insertBefore(_active, _this.slides[0]);
